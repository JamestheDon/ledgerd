/**
 *  @SPEC  Returns a list of bitcoin core versions avail for download and writes to file.
 * 
 *  @todo: Compare versions to btc-core thats installed to found versions.
...
getCoreVersions();
// module.exports = {getCoreVersions}
